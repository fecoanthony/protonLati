...
import "./ProtonSignIn.css";

export default function ProtonSignIn() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "rgb(242, 219, 252)", minHeight: "100vh" }}
    >
      ...
      <div className="form-container">
        <div className="main-box">
          <form onSubmit={handleSubmit}>
            <div className="signin-tocontinue">
              <h1>Sign in</h1>
              <div className="to-continue">to continue to Proton Mail</div>
            </div>
            ...
            {/* Password */}
            <div className="form-space" style={{ marginTop: 20 }}>
            ...
            {/* Checkbox */}
            <div className="check-area" style={{ marginTop: 20 }}>
              <input
                type="checkbox"
              ...
              <div className="keep-why">
                <label className="keep-me">Keep me signed in</label>
            ...
            <div className="new-to">
              New to Proton?{" "}
              <a className="create" href="/mail/signup">
                Create account
              </a>
            </div>
            ...
            <div className="trouble-div">
              <a className="trouble" href="/mail/signup">
                Trouble signing in
              </a>
            </div>
          </form>
